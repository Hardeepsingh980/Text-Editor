...
class text_editor:
    ...
    def tcolor(self):
        ...
        #tc = Tk()
        #Label(tc, text='Enter Text Color',font=('arial black',10),width=20,bg='light grey').pack()

        #Label(tc,text='').pack()

        #colours = ['Red','Black','Blue','Green','Yellow','Pink']

        #c = Combobox(tc, values=colours)
        #c.set('Select Color')
        #c.pack()
        ...
        #Button(tc, text='Apply Changes',font=('arial black',10),command=change_color).pack()
    ...
    def more(self):
        ...
        Label(more, text='This Text Editor was created by Hardeep Singh\nas a hobby project just for time-pass\n This was his one of the first project that he did.',bg='powder blue',font=('Arial Black',10,'bold')).pack()
